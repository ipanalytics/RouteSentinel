...
Last successful snapshot: **2026-07-26**
Release assets: [2026-07-26](https://github.com/ipanalytics/RouteSentinel/releases/tag/2026-07-26)
Release updated: **2026-07-26 08:26 UTC**

| Metric | Value |
| --- | ---: |
| Collectors | rrc00, rrc01, rrc10 |
| Unique prefixes | 1,429,953 |
| Unique prefix-origin pairs | 1,443,693 |
| RPKI valid | 1,005,217 |
| RPKI invalid | 8,258 |
| Unique invalid prefixes | 8,194 |
| RPKI not-found | 430,218 |
