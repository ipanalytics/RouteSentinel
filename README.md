...
Last successful snapshot: **2026-07-27**
Release assets: [2026-07-27](https://github.com/ipanalytics/RouteSentinel/releases/tag/2026-07-27)
Release updated: **2026-07-27 09:51 UTC**

| Metric | Value |
| --- | ---: |
| Collectors | rrc00, rrc01, rrc10 |
| Unique prefixes | 1,430,682 |
| Unique prefix-origin pairs | 1,444,283 |
| RPKI valid | 1,005,427 |
| RPKI invalid | 8,212 |
| Unique invalid prefixes | 8,146 |
| RPKI not-found | 430,644 |
| RPKI coverage ratio | 69.61% |
