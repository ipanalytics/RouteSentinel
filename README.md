...
Last successful snapshot: **2026-08-09**
Release assets: [2026-08-09](https://github.com/ipanalytics/RouteSentinel/releases/tag/2026-08-09)
Release updated: **2026-08-09 06:56 UTC**

| Metric | Value |
| --- | ---: |
| Collectors | rrc00, rrc01, rrc10 |
| Unique prefixes | 1,413,750 |
| Unique prefix-origin pairs | 1,423,788 |
| RPKI valid | 1,006,590 |
| RPKI invalid | 3,860 |
| Unique invalid prefixes | 3,841 |
| RPKI not-found | 413,338 |
| RPKI coverage ratio | 70.70% |
