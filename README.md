...
Last successful snapshot: **2026-08-23**
Release assets: [2026-08-23](https://github.com/ipanalytics/RouteSentinel/releases/tag/2026-08-23)
Release updated: **2026-08-23 06:39 UTC**

| Metric | Value |
| --- | ---: |
| Collectors | rrc00, rrc01, rrc10 |
| Unique prefixes | 1,421,728 |
| Unique prefix-origin pairs | 1,431,501 |
| RPKI valid | 1,012,950 |
| RPKI invalid | 3,570 |
| Unique invalid prefixes | 3,552 |
| RPKI not-found | 414,981 |
| RPKI coverage ratio | 70.76% |
